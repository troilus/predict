        ...
        if let savedLanguage = UserDefaults.standard.string(forKey: languageKey),
           let language = Language(rawValue: savedLanguage) {
            ...
            if #available(iOS 16, *) {
                ...
                currentLanguage = langCode.hasPrefix("zh") ? .chinese : .english
            } else {
                let systemLanguage = Locale.current.languageCode ?? Locale.current.identifier
                currentLanguage = systemLanguage.hasPrefix("zh") ? .chinese : .english
            }
        }
    }
}
...
struct Localization {
    static let strings: [LanguageManager.Language: [String: String]] = [
        ...
        .english: [
            ...
            "update_tle": "Update TLE Data",
            "update_transmitters": "Update Transmitters Data",
            "reset_settings": "Reset Settings",
            "reset_settings_confirm": "Are you sure you want to reset all settings?",
            "app_info": "App Info",
            "app_version": "App Version",
            "tle_version": "TLE Version",
            "done": "Done",
            "reset": "Reset",
