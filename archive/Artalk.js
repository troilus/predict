! function(e, t) {
    ...
    var t = Object.defineProperty,
        ...
        l = (e, t) => {
            ...
            if (i)
                for (var n of i(t)) o.call(t, n) && a(e, n, t[n]);
            return e
        },
        c = (e, t) => n(e, s(t)),
        d = (e, t, n) => a(e, "symbol" != typeof t ? t + "" : t, n),
        h = (e, t, n) => new Promise(((s, i) => {
            var r = e => {
                    try {
                        a(n.next(e))
                    } catch (t) {
    ...
    class u {
        constructor(e = {}) {
            d(this, "baseUrl", "/api/v2"), d(this, "securityData", null), d(this, "securityWorker"), d(this, "abortControllers", new Map), d(this, "customFetch", ((...e) => fetch(...e))), d(this, "baseApiParams", {
                ...
                "application/json": e => null === e || "object" != typeof e && "string" != typeof e ? e : JSON.stringify(e),
                "text/plain": e => null !== e && "string" != typeof e ? JSON.stringify(e) : e,
                "multipart/form-data": e => Object.keys(e || {}).reduce(((t, n) => {
                    const s = e[n];
                    return t.append(n, s instanceof Blob ? s : "object" == typeof s && null !== s ? JSON.stringify(s) : `${s}`), t
                }), new FormData),
            ...
            })), d(this, "request", (e => h(this, null, (function*() {
                var t = e,
                    {
                        body: n,
                        secure: s,
                    ...
                    f = ((e, t) => {
                        ...
                        if (null != e && i)
                            for (var s of i(e)) t.indexOf(s) < 0 && o.call(e, s) && (n[s] = e[s]);
                        return n
                    })(t, ["body", "secure", "path", "type", "query", "format", "baseUrl", "cancelToken"]);
                const k = ("boolean" == typeof s ? s : this.baseApiParams.secure) && this.securityWorker && (yield this.securityWorker(this.securityData)) || {},
                    y = this.mergeRequestParams(f, k),
                    $ = u && this.toQueryString(u),
                    v = this.contentFormatters[d || "application/json"],
                    w = p || y.format;
                return this.customFetch(`${g||this.baseUrl||""}${a}${$?`?${$}`:""}`, c(l({}, y), {
                    headers: l(l({}, y.headers || {}), d && "multipart/form-data" !== d ? {
                        "Content-Type": d
                    } : {}),
                    signal: (m ? this.createAbortSignal(m) : y.signal) || null,
                    body: null == n ? null : v(n)
                })).then((e => h(this, null, (function*() {
                    const t = e.clone();
                    t.data = null, t.error = null;
                    const n = w ? yield e[w]().then((e => (t.ok ? t.data = e : t.error = e, t))).catch((e => (t.error = e, t))): t;
        ...
        mergeRequestParams(e, t) {
            return c(l(l(l({}, this.baseApiParams), e), t || {}), {
                headers: l(l(l({}, this.baseApiParams.headers || {}), e.headers || {}), t && t.headers || {})
            })
        }
    }
    /**
    ...
    let p = class extends u {
        constructor() {
            super(...arguments), d(this, "auth", {
                loginByEmail: (e, t = {}) => this.request(l({
                ...
                registerByEmail: (e, t = {}) => this.request(l({
                ...
                sendVerifyEmail: (e, t = {}) => this.request(l({
                ...
                checkDataMerge: (e = {}) => this.request(l({
                    path: "/auth/merge",
                    method: "GET",
                    secure: !0,
                    format: "json"
                }, e)),
                applyDataMerge: (e, t = {}) => this.request(l({
                    path: "/auth/merge",
                    method: "POST",
                    body: e,
                    secure: !0,
                ...
                flushCache: (e = {}) => this.request(l({
                    path: "/cache/flush",
                    method: "POST",
                    secure: !0,
                    format: "json"
                }, e)),
                warmUpCache: (e = {}) => this.request(l({
                    path: "/cache/warm_up",
                    method: "POST",
                    secure: !0,
                    format: "json"
                ...
                getCaptcha: (e = {}) => this.request(l({
                    path: "/captcha",
                    method: "GET",
                    format: "json"
                }, e)),
                getCaptchaStatus: (e = {}) => this.request(l({
                    path: "/captcha/status",
                    method: "GET",
                    format: "json"
                }, e)),
                verifyCaptcha: (e, t = {}) => this.request(l({
                    path: "/captcha/verify",
                    method: "POST",
                    body: e,
                    type: "application/json",
                ...
                getComments: (e, t = {}) => this.request(l({
                    path: "/comments",
                    method: "GET",
                    query: e,
                    secure: !0,
                ...
                createComment: (e, t = {}) => this.request(l({
                    path: "/comments",
                    method: "POST",
                    body: e,
                    secure: !0,
                ...
                getComment: (e, t = {}) => this.request(l({
                    path: `/comments/${e}`,
                    method: "GET",
                    type: "application/json",
                    format: "json"
                }, t)),
                updateComment: (e, t, n = {}) => this.request(l({
                    path: `/comments/${e}`,
                    method: "PUT",
                    body: t,
                    secure: !0,
                ...
                deleteComment: (e, t = {}) => this.request(l({
                    path: `/comments/${e}`,
                    method: "DELETE",
                    secure: !0,
                    format: "json"
                ...
                conf: (e = {}) => this.request(l({
                    path: "/conf",
                    method: "GET",
                    format: "json"
                }, e)),
                getSocialLoginProviders: (e = {}) => this.request(l({
                    path: "/conf/auth/providers",
                    method: "GET",
                    format: "json"
                }, e)),
                getDomain: (e, t = {}) => this.request(l({
                    path: "/conf/domain",
                    method: "GET",
                    query: e,
                    format: "json"
                ...
                getNotifies: (e, t = {}) => this.request(l({
                    path: "/notifies",
                    method: "GET",
                    query: e,
                    type: "application/json",
                ...
                markAllNotifyRead: (e, t = {}) => this.request(l({
                    path: "/notifies/read",
                    method: "POST",
                    body: e,
                    type: "application/json",
                ...
                markNotifyRead: (e, t, n = {}) => this.request(l({
                    path: `/notifies/${e}/${t}`,
                    method: "POST",
                    format: "json"
                }, n))
            }), d(this, "pages", {
                getPages: (e, t = {}) => this.request(l({
                    path: "/pages",
                    method: "GET",
                    query: e,
                    secure: !0,
                ...
                fetchAllPages: (e, t = {}) => this.request(l({
                    path: "/pages/fetch",
                    method: "POST",
                    body: e,
                    secure: !0,
                ...
                getPageFetchStatus: (e = {}) => this.request(l({
                    path: "/pages/fetch/status",
                    method: "GET",
                    secure: !0,
                    format: "json"
                }, e)),
                logPv: (e, t = {}) => this.request(l({
                    path: "/pages/pv",
                    method: "POST",
                    body: e,
                    type: "application/json",
                ...
                updatePage: (e, t, n = {}) => this.request(l({
                    path: `/pages/${e}`,
                    method: "PUT",
                    body: t,
                    secure: !0,
                ...
                deletePage: (e, t = {}) => this.request(l({
                    path: `/pages/${e}`,
                    method: "DELETE",
                    secure: !0,
                    format: "json"
                }, t)),
                fetchPage: (e, t = {}) => this.request(l({
                    path: `/pages/${e}/fetch`,
                    method: "POST",
                    secure: !0,
                    type: "application/json",
                ...
                getSettings: (e = {}) => this.request(l({
                    path: "/settings",
                    method: "GET",
                    secure: !0,
                    format: "json"
                }, e)),
                applySettings: (e, t = {}) => this.request(l({
                    path: "/settings",
                    method: "PUT",
                    body: e,
                    secure: !0,
                ...
                getSettingsTemplate: (e, t = {}) => this.request(l({
                ...
                getSites: (e = {}) => this.request(l({
                    path: "/sites",
                    method: "GET",
                    secure: !0,
                    format: "json"
                }, e)),
                createSite: (e, t = {}) => this.request(l({
                    path: "/sites",
                    method: "POST",
                    body: e,
                    secure: !0,
                ...
                updateSite: (e, t, n = {}) => this.request(l({
                    path: `/sites/${e}`,
                    method: "PUT",
                    body: t,
                    secure: !0,
                ...
                exportArtrans: (e = {}) => this.request(l({
                    path: "/transfer/export",
                    method: "GET",
                    secure: !0,
                    format: "json"
                }, e)),
                importArtrans: (e, t = {}) => this.request(l({
                ...
                uploadArtrans: (e, t = {}) => this.request(l({
                ...
                updateProfile: (e, t = {}) => this.request(l({
                    path: "/user",
                    method: "POST",
                    body: e,
                    secure: !0,
                ...
                getUserStatus: (e, t = {}) => this.request(l({
                    path: "/user/status",
                    method: "GET",
                    query: e,
                    secure: !0,
                ...
                updateUser: (e, t, n = {}) => this.request(l({
                    path: `/users/${e}`,
                    method: "PUT",
                    body: t,
                    secure: !0,
                ...
                deleteUser: (e, t = {}) => this.request(l({
                    path: `/users/${e}`,
                    method: "DELETE",
                    secure: !0,
                    format: "json"
                }, t)),
                getUsers: (e, t, n = {}) => this.request(l({
                    path: `/users/${e}`,
                    method: "GET",
                    query: t,
                    secure: !0,
                ...
                getVersion: (e = {}) => this.request(l({
                    path: "/version",
                    method: "GET",
                    format: "json"
                }, e))
            }), d(this, "votes", {
                syncVotes: (e = {}) => this.request(l({
                    path: "/votes/sync",
                    method: "POST",
                    secure: !0,
                    format: "json"
                }, e)),
                vote: (e, t, n, s = {}) => this.request(l({
                    path: `/votes/${e}/${t}`,
                    method: "POST",
                    body: n,
                    type: "application/json",
    ...
    const g = (e, t, n) => h(this, null, (function*() {
        const s = e.getApiToken && e.getApiToken(),
            i = new Headers(l({
                Authorization: s ? `Bearer ${s}` : ""
            }, null == n ? void 0 : n.headers));
        i.get("Authorization") || i.delete("Authorization");
        const r = yield fetch(t, c(l({}, n), {
            headers: i
        }));
        if (!r.ok) {
            const s = (yield r.json().catch((() => {}))) || {};
            let i = !1;
            if (e.handlers && (yield e.handlers.get().reduce(((e, t) => h(this, null, (function*() {
                    yield e, !0 === s[t.action] && (yield t.handler(s), i = !0)
                }))), Promise.resolve())), i) return g(e, t, n);
            throw function(e, t) {
                const n = new m;
                return n.message = t.msg || t.message || "fetch error", n.code = e, n.data = t, console.error(n), n
            }(r.status, s)
        }
        return r
    }));
    ...
    class f extends p {
        constructor(e) {
            super({
                baseUrl: e.baseURL,
                customFetch: (t, n) => g(e, t, n)
            }), d(this, "_opts"), this._opts = e
        }
        getUserFields() {
            const e = this._opts.userInfo;
            if ((null == e ? void 0 : e.name) && (null == e ? void 0 : e.email)) return {
                name: e.name,
                email: e.email
            }
        }
    ...
    class U {
        constructor(e) {
            d(this, "options"), d(this, "rules"), d(this, "lexer"), this.options = e || y
        }
        space(e) {
        ...
        blockquote(e) {
            ...
            if (t) {
                ...
                for (; e.length > 0;) {
                    ...
                    if (this.lexer.state.top = !0, this.lexer.blockTokens(l, i, !0), this.lexer.state.top = c, 0 === e.length) break;
                    ...
                    if ("blockquote" === (null == d ? void 0 : d.type)) {
                        const t = d,
                            r = t.raw + "\n" + e.join("\n"),
                            o = this.blockquote(r);
                        i[i.length - 1] = o, n = n.substring(0, n.length - t.raw.length) + o.raw, s = s.substring(0, s.length - t.text.length) + o.text;
                        break
                    }
                    if ("list" !== (null == d ? void 0 : d.type));
                        ...
                        const t = d,
                            r = t.raw + "\n" + e.join("\n"),
                            o = this.list(r);
                        i[i.length - 1] = o, n = n.substring(0, n.length - d.raw.length) + o.raw, s = s.substring(0, s.length - t.raw.length) + o.raw, e = r.substring(i[i.length - 1].raw.length).split("\n")
                    }
                }
                return {
                    type: "blockquote",
            ...
            if (t) {
                ...
                for (; e;) {
                    ...
                    let l = t[2].split("\n", 1)[0].replace(/^\t+/, (e => " ".repeat(3 * e.length))),
                        ...
                        d = !l.trim(),
                        h = 0;
                    if (this.options.pedantic ? (h = 2, a = l.trimStart()) : d ? h = t[1].length + 1 : (h = t[2].search(/[^ ]/), h = h > 4 ? 1 : h, a = l.slice(h), h += t[1].length), d && /^[ \t]*$/.test(c) && (s += c + "\n", e = e.substring(c.length + 1), n = !0), !n) {
                        ...
                        for (; e;) {
                            const u = e.split("\n", 1)[0];
                            let p;
                            if (c = u, this.options.pedantic ? (c = c.replace(/^ {1,4}(?=( {4})*[^ ])/g, "  "), p = c) : p = c.replace(/\t/g, "    "), i.test(c)) break;
                            if (r.test(c)) break;
                            if (o.test(c)) break;
                            if (t.test(c)) break;
                            if (n.test(c)) break;
                            ...
                            d || c.trim() || (d = !0), s += u + "\n", e = e.substring(u.length + 1), l = p.slice(h)
                        }
                    }
                    i.loose || (o ? i.loose = !0 : /\n[ \t]*\n[ \t]*$/.test(s) && (o = !0));
                    let u, p = null;
                    this.options.gfm && (p = /^\[[ xX]\] /.exec(a), p && (u = "[ ] " !== p[0], a = a.replace(/^\[[ xX]\] +/, ""))), i.items.push({
                        type: "list_item",
                        raw: s,
                        task: !!p,
                        checked: u,
        ...
        table(e) {
            ...
            if (n.length === s.length) {
                for (const e of s) /^ *-+: *$/.test(e) ? r.align.push("right") : /^ *:-+: *$/.test(e) ? r.align.push("center") : /^ *:-+ *$/.test(e) ? r.align.push("left") : r.align.push(null);
                for (let e = 0; e < n.length; e++) r.header.push({
                    text: n[e],
                    tokens: this.lexer.inline(n[e]),
                    header: !0,
                    align: r.align[e]
                });
                for (const e of i) r.rows.push(P(e, r.header.length).map(((e, t) => ({
                    text: e,
                    tokens: this.lexer.inline(e),
                    header: !1,
                    align: r.align[t]
        ...
        link(e) {
            ...
            if (t) {
                ...
                return n = n.trim(), /^</.test(n) && (n = this.options.pedantic && !/>$/.test(e) ? n.slice(1) : n.slice(1, -1)), R(t, {
        ...
        emStrong(e, t, n = "") {
            ...
            if (!(s[1] || s[2] || "") || !n || this.rules.inline.punctuation.exec(n)) {
                ...
                for (l.lastIndex = 0, t = t.slice(-1 * e.length + n); null != (s = l.exec(t));) {
        ...
        codespan(e) {
            ...
            if (t) {
                ...
                const n = /[^ ]/.test(e),
                    s = /^ /.test(e) && / $/.test(e);
                return n && s && (e = e.substring(1, e.length - 1)), e = S(e, !0), {
                    type: "codespan",
                    raw: t[0],
                    text: e
                }
        ...
        autolink(e) {
            ...
            if (t) {
                let e, n;
                return "@" === t[2] ? (e = S(t[1]), n = "mailto:" + e) : (e = S(t[1]), n = e), {
                    type: "link",
                    raw: t[0],
                    text: e,
                    href: n,
        ...
        url(e) {
            ...
            if (s = this.rules.inline.url.exec(e)) {
                ...
                if ("@" === s[2]) e = S(s[0]), i = "mailto:" + e;
                    ...
                    let r;
                    do {
                        r = s[0], s[0] = null != (n = null == (t = this.rules.inline._backpedal.exec(s[0])) ? void 0 : t[0]) ? n : ""
                    } while (r !== s[0]);
        ...
        inlineText(e) {
            ...
            if (t) {
                let e;
                return e = this.lexer.state.inRawBlock ? t[0] : S(t[0]), {
                    type: "text",
                    raw: t[0],
                    text: e
                }
    ...
    const q = /^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,
        ...
        z = /<!--(?:-?>|[\s\S]*?(?:-->|$))/,
        N = A("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ \t]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ \t]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ \t]*)+\\n|$))", "i").replace("comment", z).replace("tag", W).replace("attribute", / +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),
        H = A(D).replace("hr", q).replace("heading", " {0,3}#{1,6}(?:\\s|$)").replace("|lheading", "").replace("|table", "").replace("blockquote", " {0,3}>").replace("fences", " {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list", " {0,3}(?:[*+-]|1[.)]) ").replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag", W).getRegex(),
        Q = {
            blockquote: A(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph", H).getRegex(),
            code: /^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,
            def: j,
            fences: /^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,
            heading: /^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,
        ...
        G = c(l({}, Q), {
            table: V,
            paragraph: A(D).replace("hr", q).replace("heading", " {0,3}#{1,6}(?:\\s|$)").replace("|lheading", "").replace("table", V).replace("blockquote", " {0,3}>").replace("fences", " {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list", " {0,3}(?:[*+-]|1[.)]) ").replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag", W).getRegex()
        }),
        K = c(l({}, Q), {
            html: A("^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:\"[^\"]*\"|'[^']*'|\\s[^'\"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))").replace("comment", z).replace(/tag/g, "(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),
            def: /^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,
            heading: /^(#{1,6})(.*)(?:\n+|$)/,
            fences: M,
            lheading: /^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,
        ...
        Y = /^( {2,}|\\)\n(?!\s*$)/,
        X = "\\p{P}\\p{S}",
        J = A(/^((?![*_])[\spunctuation])/, "u").replace(/punctuation/g, X).getRegex(),
        ee = A(/^(?:\*+(?:((?!\*)[punct])|[^\s*]))|^_+(?:((?!_)[punct])|([^\s_]))/, "u").replace(/punct/g, X).getRegex(),
        te = A("^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)[punct](\\*+)(?=[\\s]|$)|[^punct\\s](\\*+)(?!\\*)(?=[punct\\s]|$)|(?!\\*)[punct\\s](\\*+)(?=[^punct\\s])|[\\s](\\*+)(?!\\*)(?=[punct])|(?!\\*)[punct](\\*+)(?!\\*)(?=[punct])|[^punct\\s](\\*+)(?=[^punct\\s])", "gu").replace(/punct/g, X).getRegex(),
        ne = A("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)[punct](_+)(?=[\\s]|$)|[^punct\\s](_+)(?!_)(?=[punct\\s]|$)|(?!_)[punct\\s](_+)(?=[^punct\\s])|[\\s](_+)(?!_)(?=[punct])|(?!_)[punct](_+)(?!_)(?=[punct])", "gu").replace(/punct/g, X).getRegex(),
        se = A(/\\([punct])/, "gu").replace(/punct/g, X).getRegex(),
        ie = A(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme", /[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email", /[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),
        re = A(z).replace("(?:--\x3e|$)", "--\x3e").getRegex(),
        oe = A("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment", re).replace("attribute", /\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),
        ae = /(?:\[(?:\\.|[^\[\]\\])*\]|\\.|`[^`]*`|[^\[\]\\`])*?/,
        le = A(/^!?\[(label)\]\(\s*(href)(?:\s+(title))?\s*\)/).replace("label", ae).replace("href", /<(?:\\.|[^\n<>\\])+>|[^\s\x00-\x1f]*/).replace("title", /"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),
        ce = A(/^!?\[(label)\]\[(ref)\]/).replace("label", ae).replace("ref", B).getRegex(),
        de = A(/^!?\[(ref)\](?:\[\])?/).replace("ref", B).getRegex(),
        he = {
            _backpedal: M,
            anyPunctuation: se,
            autolink: ie,
            ...
            punctuation: J,
            reflink: ce,
            reflinkSearch: A("reflink|nolink(?!\\()", "g").replace("reflink", ce).replace("nolink", de).getRegex(),
            tag: oe,
            text: /^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,
            url: M
        },
        ...
        ge = c(l({}, pe), {
            ...
            text: A(pe.text).replace("\\b_", "\\b_| {2,}\\n").replace(/\{2,\}/g, "*").getRegex()
        }),
        me = {
            normal: Q,
            gfm: G,
    ...
    class ke {
        constructor(e) {
            d(this, "tokens"), d(this, "options"), d(this, "state"), d(this, "tokenizer"), d(this, "inlineQueue"), this.tokens = [], this.tokens.links = Object.create(null), this.options = e || y, this.options.tokenizer = this.options.tokenizer || new U, this.tokenizer = this.options.tokenizer, this.tokenizer.options = this.options, this.tokenizer.lexer = this, this.inlineQueue = [], this.state = {
                inLink: !1,
                inRawBlock: !1,
                top: !0
            };
            ...
            this.options.pedantic ? (t.block = me.pedantic, t.inline = fe.pedantic) : this.options.gfm && (t.block = me.gfm, this.options.breaks ? t.inline = fe.breaks : t.inline = fe.gfm), this.tokenizer.rules = t
        }
        static get rules() {
            return {
                block: me,
        ...
        blockTokens(e, t = [], n = !1) {
            ...
            for (this.options.pedantic && (e = e.replace(/\t/g, "    ").replace(/^ +$/gm, "")); e;)
                if (!(this.options.extensions && this.options.extensions.block && this.options.extensions.block.some((n => !!(s = n.call({
                    ...
                    else if (s = this.tokenizer.code(e)) e = e.substring(s.raw.length), i = t[t.length - 1], !i || "paragraph" !== i.type && "text" !== i.type ? t.push(s) : (i.raw += "\n" + s.raw, i.text += "\n" + s.text, this.inlineQueue[this.inlineQueue.length - 1].src = i.text);
            ...
            else if (s = this.tokenizer.def(e)) e = e.substring(s.raw.length), i = t[t.length - 1], !i || "paragraph" !== i.type && "text" !== i.type ? this.tokens.links[s.tag] || (this.tokens.links[s.tag] = {
                href: s.href,
                title: s.title
            }) : (i.raw += "\n" + s.raw, i.text += "\n" + s.raw, this.inlineQueue[this.inlineQueue.length - 1].src = i.text);
        ...
        inlineTokens(e, t = []) {
            ...
            if (this.tokens.links) {
                ...
                if (e.length > 0)
                    for (; null != (r = this.tokenizer.rules.inline.reflinkSearch.exec(l));) e.includes(r[0].slice(r[0].lastIndexOf("[") + 1, -1)) && (l = l.slice(0, r.index) + "[" + "a".repeat(r[0].length - 2) + "]" + l.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex))
            }
            for (; null != (r = this.tokenizer.rules.inline.blockSkip.exec(l));) l = l.slice(0, r.index) + "[" + "a".repeat(r[0].length - 2) + "]" + l.slice(this.tokenizer.rules.inline.blockSkip.lastIndex);
            for (; null != (r = this.tokenizer.rules.inline.anyPunctuation.exec(l));) l = l.slice(0, r.index) + "++" + l.slice(this.tokenizer.rules.inline.anyPunctuation.lastIndex);
            for (; e;)
                if (o || (a = ""), o = !1, !(this.options.extensions && this.options.extensions.inline && this.options.extensions.inline.some((s => !!(n = s.call({
                        lexer: this
                ...
                if (n = this.tokenizer.inlineText(i)) e = e.substring(n.raw.length), "_" !== n.raw.slice(-1) && (a = n.raw.slice(-1)), o = !0, s = t[t.length - 1], s && "text" === s.type ? (s.raw += n.raw, s.text += n.text) : t.push(n);
                else if (e) {
                    const t = "Infinite loop on byte: " + e.charCodeAt(0);
                    if (this.options.silent) {
                        console.error(t);
    ...
    class ve {
        constructor(e) {
            d(this, "options"), d(this, "renderer"), d(this, "textRenderer"), this.options = e || y, this.options.renderer = this.options.renderer || new ye, this.renderer = this.options.renderer, this.renderer.options = this.options, this.renderer.parser = this, this.textRenderer = new $e
        }
        static parse(e, t) {
            ...
            for (let s = 0; s < e.length; s++) {
                ...
                switch (r.type) {
                    ...
                    case "text": {
                        ...
                        for (; s + 1 < e.length && "text" === e[s + 1].type;) i = e[++s], o += "\n" + this.renderer.text(i);
    ...
    d(we, "passThroughHooks", new Set(["preprocess", "postprocess", "processAllTokens"]));
    class be {
        constructor(...e) {
            d(this, "defaults", {
                async: !1,
                ...
                tokenizer: null,
                walkTokens: null
            }), d(this, "options", this.setOptions), d(this, "parse", this.parseMarkdown(!0)), d(this, "parseInline", this.parseMarkdown(!1)), d(this, "Parser", ve), d(this, "Renderer", ye), d(this, "TextRenderer", $e), d(this, "Lexer", ke), d(this, "Tokenizer", U), d(this, "Hooks", we), this.use(...e)
        }
        walkTokens(e, t) {
            var n, s;
            let i = [];
            for (const r of e) switch (i = i.concat(t.call(this, r)), r.type) {
                case "table": {
                    const e = r;
                    for (const n of e.header) i = i.concat(this.walkTokens(n.tokens, t));
                ...
                if (e.hooks) {
                    ...
                    for (const n in e.hooks) {
                        ...
                        const s = n,
                            i = e.hooks[s],
                            r = t[s];
                        we.passThroughHooks.has(n) ? t[s] = e => {
        ...
        parseMarkdown(e) {
            return (t, n) => {
                ...
                if (!0 === this.defaults.async && !1 === s.async) return r(new Error("marked(): The async option was set to true by an extension. Remove async: false from the parse options object to return a Promise."));
                if (null == t) return r(new Error("marked(): input parameter is undefined or null"));
                if ("string" != typeof t) return r(new Error("marked(): input parameter is of type " + Object.prototype.toString.call(t) + ", string expected"));
                ...
                if (i.async) return Promise.resolve(i.hooks ? i.hooks.preprocess(t) : t).then((e => o(e, i))).then((e => i.hooks ? i.hooks.processAllTokens(e) : e)).then((e => i.walkTokens ? Promise.all(this.walkTokens(e, i.walkTokens)).then((() => e)) : e)).then((e => a(e, i))).then((e => i.hooks ? i.hooks.postprocess(e) : e)).catch(r);
                try {
        ...
        onError(e, t) {
            return n => {
                if (n.message += "\nPlease report this to https://github.com/markedjs/marked.", e) {
                    const e = "<p>An error occurred:</p><pre>" + S(n.message + "", !0) + "</pre>";
    ...
    }, Ce.getDefaults = k, Ce.defaults = y, Ce.use = function(...e) {
    ...
    var qe = function e(t) {
            for (var n, s, i = Array.prototype.slice.call(arguments, 1); i.length;)
                for (s in n = i.shift()) n.hasOwnProperty(s) && ("[object Object]" === Object.prototype.toString.call(t[s]) ? t[s] = e(t[s], n[s]) : t[s] = n[s]);
            return t
        },
        _e = function(e) {
    ...
    var De = function(e) {
        ...
        Be = {
            uris: De(["background", "base", "cite", "href", "longdesc", "src", "usemap"])
        },
        je = {
            voids: De(["area", "br", "col", "hr", "img", "wbr", "input", "base", "basefont", "link", "meta"])
        },
        Fe = Ue,
        We = _e,
        ze = je,
        Ne = /^<\s*([\w:-]+)((?:\s+[\w:-]+(?:\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|[^>\s]+))?)*)\s*(\/?)\s*>/,
        He = /^<\s*\/\s*([\w:-]+)[^>]*>/,
        Qe = /([\w:-]+)(?:\s*=\s*(?:(?:"((?:[^"])*)")|(?:'((?:[^'])*)')|([^>\s]+)))?/g,
        Ve = /^</,
        Ge = /^<\s*\//;
    ...
    var Je = qe,
        et = function(e, t) {
            ...
            function r() {
                n = !0,
                    function() {
                        "\x3c!--" === e.substr(0, 4) ? (s = e.indexOf("--\x3e")) >= 0 && (t.comment && t.comment(e.substring(4, s)), e = e.substring(s + 3), n = !1) : Ge.test(e) ? o(He, l) : Ve.test(e) && o(Ne, a);
                        var s;
                        ! function() {
                            if (!n) return;
                            var s, i = e.indexOf("<");
                            i >= 0 ? (s = e.substring(0, i), e = e.substring(i)) : (s = e, e = "");
                            t.chars && t.chars(s)
                        }()
                    }();
                var s = e === i;
            ...
            function a(e, n, i, r) {
                ...
                i.replace(Qe, (function(e, t, n, s, i) {
                    o[t] = void 0 === n && void 0 === s && void 0 === i ? void 0 : Fe.decode(n || s || i || "")
                })), l || s.push(a), t.start && t.start(a, o, l)
            }
        ...
        tt = function(e, t) {
            ...
            return a(), {
                start: function(e, t, o) {
                    ...
                    i("<"), i(a), Object.keys(t).forEach((function(e) {
                        var n = t[e],
                            r = (s.allowedClasses || {})[a] || [],
                            o = (s.allowedAttributes || {})[a] || [],
                            l = Ze(e);
                        ("class" === l && -1 === o.indexOf(l) ? (n = n.split(" ").filter((function(e) {
                            return r && -1 !== r.indexOf(e)
                        })).join(" ").trim()).length : -1 !== o.indexOf(l) && (!0 !== Ye.uris[l] || function(e) {
                            var t = e[0];
                            if ("#" === t || "/" === t) return !0;
                            var n = e.indexOf(":");
                            if (-1 === n) return !0;
                        ...
                        }(n))) && (i(" "), i(e), "string" == typeof n && (i('="'), i(Ke.encode(n)), i('"')))
                    })), i(o ? "/>" : ">")
                },
                end: function(e) {
                    var t = Ze(e); - 1 !== (s.allowedTags || []).indexOf(t) && !1 === n.ignoring ? (i("</"), i(t), i(">")) : o(t)
                },
                chars: function(e) {
    ...
    const it = Ee(st),
        rt = {
            ...
            })), "span" === e.tag && e.attrs.style && !/^color:(\W+)?#[0-9a-f]{3,6};?$/i.test(e.attrs.style) && delete e.attrs.style, !0)
        };
    ...
    function dt(e) {
        ...
        return t.link = ht(t, t.link), t.code = ut(), t.image = pt(t, t.image, e), t
    }
    const ht = (e, t) => n => {
            const s = (e => {
                try {
            ...
            return t.call(e, n).replace(/^<a /, `<a target="_blank" ${s?"":'rel="noreferrer noopener nofollow"'} `)
        },
        ut = () => ({
            lang: e,
            text: t
            ...
            const n = e || "plaintext";
            let s = t;
            return window.hljs ? n && window.hljs.getLanguage(n) && (s = window.hljs.highlight(n, t).value) : s = ct(t), `<pre rel="${n}">\n<code class="hljs language-${n}">${s.replace(/&amp;/g,"&")}</code>\n</pre>`
        },
        pt = (e, t, {
            imgLazyLoad: n
        }) => s => {
            const i = t.call(e, s);
            return n ? "native" === n || !0 === n ? i.replace(/^<img /, '<img class="lazyload" loading="lazy" ') : "data-src" === n ? i.replace(/^<img /, '<img class="lazyload" ').replace("src=", "data-src=") : i : i
        };
    let gt, mt = [];
    const ft = {
        gfm: !0,
    ...
    function yt(e) {
        ...
        n || (n = function(e) {
            return e.replace(/```\s*([^]+?.*?[^]+?[^]+?)```/g, ((e, t) => `<pre><code>${ct(t)}</code></pre>`)).replace(/!\[(.*?)\]\((.*?)\)/g, ((e, t, n) => `<img src="${n}" alt="${t}" />`)).replace(/\[(.*?)\]\((.*?)\)/g, ((e, t, n) => `<a href="${n}" target="_blank">${t}</a>`)).replace(/\n/g, "<br>")
        }(e));
        let s = ot(n);
        return mt.forEach((e => {
    ...
    function $t(...e) {
        ...
        return e.reduce(((e, n) => (Object.keys(null != n ? n : {}).forEach((s => {
            if ("__proto__" === s || "constructor" === s || "prototype" === s) return;
            const i = e[s],
                r = n[s];
            Array.isArray(i) && Array.isArray(r) ? e[s] = i.concat(...r) : t(i) && t(r) ? e[s] = $t(i, r) : e[s] = r
        })), e)), {})
    }
    class vt {
        constructor(e) {
            d(this, "loading", !1), d(this, "listLastFetch"), d(this, "comments", []), d(this, "notifies", []), d(this, "page"), this.events = e
        }
        getLoading() {
            return this.loading
        }
        ...
        loadComments(e) {
            this.events.trigger("list-load", e), this.comments.push(...e), this.events.trigger("list-loaded", this.comments)
        }
        insertComment(e) {
            this.comments.push(e), this.events.trigger("comment-inserted", e), this.events.trigger("list-loaded", this.comments)
        }
        updateComment(e) {
            this.comments = this.comments.map((t => t.id === e.id ? e : t)), this.events.trigger("comment-updated", e), this.events.trigger("list-loaded", this.comments)
        }
        deleteComment(e) {
            const t = this.comments.find((t => t.id === e));
            if (!t) throw new Error(`Comment ${e} not found`);
            this.comments = this.comments.filter((t => t.id !== e)), this.events.trigger("comment-deleted", t), this.events.trigger("list-loaded", this.comments)
        }
        getNotifies() {
            return this.notifies
        }
        updateNotifies(e) {
            this.notifies = e, this.events.trigger("notifies-updated", this.notifies)
        }
        getPage() {
            return this.page
        }
    ...
    function St(e, t = e => e) {
        try {
            ...
            return i < 0 ? t("now") : i < 8 ? `${i} ${t("days")}` : function(e) {
    ...
    function Tt() {
        return h(this, null, (function*() {
            ...
            return "Windows" === t.platform && s >= 13 ? e.replace(/Windows NT 10.0/, "Windows NT 11.0") : "macOS" === t.platform && s >= 11 ? e.replace(/(Mac OS X \d+_\d+_\d+|Mac OS X)/, `Mac OS X ${n.platformVersion.replace(/\./g,"_")}`) : e
        }))
    }
    ...
    function Rt(e) {
        return e = e.replace(/^([a-zA-Z]+)(-[a-zA-Z]+)?$/, ((e, t, n) => t.toLowerCase() + (n || "").toUpperCase())), It[e] ? It[e] : window[Pt] && window[Pt][e] ? window[Pt][e] : It.en
    }
    let Ut = "en",
        qt = Rt(Ut);
    ...
    class Dt {
        ...
        trigger(e, t) {
            this.events.slice(0).filter((t => t.name === e && "function" == typeof t.handler)).forEach((n => {
    ...
    function jt(e, t = !1) {
        ...
        if (n.el && "string" == typeof n.el) try {
            ...
            throw console.error(s), new Error("Please check your Artalk `el` config.")
        }
        return "" === n.pageKey && (n.pageKey = `${window.location.pathname}`), "" === n.pageTitle && (n.pageTitle = `${document.title}`), n.server && (n.server = n.server.replace(/\/$/, "").replace(/\/api\/?$/, "")), "auto" === n.locale && (n.locale = navigator.language), "auto" === n.flatMode && (n.flatMode = window.matchMedia("(max-width: 768px)").matches), "number" == typeof n.nestMax && Number(n.nestMax) <= 1 && (n.flatMode = !0), n
    }
    ...
    function Wt(e, t, n) {
        ...
        const i = () => {
            ...
            var r, o;
            (null == s || (r = s, o = i, !(JSON.stringify(r) === JSON.stringify(o)))) && (s = i, n(i))
        };
        e.on("mounted", i), e.on("updated", i)
    }
    class zt {
        constructor(e) {
            d(this, "conf"), d(this, "data"), d(this, "$root"), d(this, "events", new Dt), d(this, "mounted", !1), d(this, "apiHandlers", null), d(this, "getCommentList", this.getCommentNodes), d(this, "getCommentDataList", this.getComments), this.conf = e, this.$root = e.el, this.$root.classList.add("artalk"), this.$root.innerHTML = "", e.darkMode && this.$root.classList.add("atk-dark-mode"), this.data = new vt(this.events), this.on("mounted", (() => {
                this.mounted = !0
            }))
        }
        inject(e, t) {
        ...
        getApiHandlers() {
            return this.apiHandlers || (this.apiHandlers = function(e) {
                const t = function() {
                    const e = [];
                    return {
                        add: (t, n) => {
                        ...
                        remove: t => {
                            const n = e.findIndex((e => e.action === t)); - 1 !== n && e.splice(n, 1)
                        },
                        get: () => e
                    }
                }();
                return t.add("need_captcha", (t => e.checkCaptcha(t))), t.add("need_login", (() => e.checkAdmin({}))), t
        ...
        updateConf(e) {
            this.conf = $t(this.conf, jt(e, !1)), this.mounted && this.events.trigger("updated", this.conf)
        }
        getConf() {
            return this.conf
        }
    ...
    function Nt(e, t) {
        ...
        n || (n = wt('<div class="atk-loading" style="display: none;">\n      <div class="atk-loading-spinner">\n        <svg viewBox="25 25 50 50"><circle cx="50" cy="50" r="20" fill="none" stroke-width="2" stroke-miterlimit="10"></circle></svg>\n      </div>\n    </div>'), (null == t ? void 0 : t.transparentBg) && (n.style.background = "transparent"), e.appendChild(n)), n.style.display = "";
        const s = n.querySelector(".atk-loading-spinner");
        s && (s.style.display = "none", window.setTimeout((() => {
    ...
    function Vt(e, t = !0, n) {
        ...
        if (n) {
            ...
            s = e.getBoundingClientRect().top - t.top + n.scrollTop - n.clientHeight / 2 + e.clientHeight / 2
        } else {
            const t = e.getBoundingClientRect();
    ...
    function Gt(e, t) {
        ! function(e, t, n = "in") {
            ...
            const s = () => {
                e.classList.remove(`atk-fade-${n}`), e.removeEventListener("animationend", s)
            };
    ...
    function Kt(e, t, n = '<span class="atk-error-title">Artalk Error</span>') {
        ...
        s || (s = wt(`<div class="atk-error-layer">${n}<span class="atk-error-text"></span></div>`), e.appendChild(s));
        const i = s.querySelector(".atk-error-text");
        i.innerHTML = "", null !== t && (t instanceof HTMLElement ? i.appendChild(t) : i.innerText = t)
    }

    function Zt(e) {
        const t = wt('<div class="atk-checker-iframe-wrap"></div>'),
            n = wt('<iframe class="atk-fade-in" referrerpolicy="strict-origin-when-cross-origin"></iframe>');
        n.style.display = "none", Nt(t, {
            transparentBg: !0
        }), n.src = e.getOpts().getCaptchaIframeURL(), n.onload = () => {
            n.style.display = "", Ht(t)
        }, t.append(n);
        const s = wt('<div class="atk-close-btn"><i class="atk-icon atk-icon-close"></i></div>');
    ...
    const Yt = {
            request: (e, t) => e.getApi().captcha.verifyCaptcha({
                value: t
            }),
            body: e => e.get("iframe") ? Zt(e) : function(e) {
                const t = wt(`<span><img class="atk-captcha-img" src="${e.get("img_data")||""}">${Ot("captchaCheck")}</span>`);
                return t.querySelector(".atk-captcha-img").onclick = () => {
                    const n = t.querySelector(".atk-captcha-img");
                    e.getApi().captcha.getCaptcha().then((e => {
            ...
            onError(e, t, n, s) {
                s.querySelector(".atk-captcha-img").click(), s.querySelector('input[type="text"]').value = ""
            }
        },
        Xt = {
            inputType: "password",
    ...
    class Jt {
        constructor(e) {
            d(this, "$el"), d(this, "$content"), d(this, "$actions"), this.$el = wt('<div class="atk-layer-dialog-wrap">\n        <div class="atk-layer-dialog">\n          <div class="atk-layer-dialog-content"></div>\n          <div class="atk-layer-dialog-actions"></div>\n        </div>\n      </div>'), this.$actions = this.$el.querySelector(".atk-layer-dialog-actions"), this.$content = this.$el.querySelector(".atk-layer-dialog-content"), this.$content.appendChild(e)
        }
        setYes(e) {
    ...
    class tn {
        constructor(e) {
            d(this, "checkCaptcha", en((e => {
                this.fire(Yt, e, (t => {
                    t.set("img_data", e.img_data), t.set("iframe", e.iframe)
                }))
            }))), d(this, "checkAdmin", en((e => {
                this.fire(Xt, e)
            }))), this.opts = e
        }
        fire(e, t, n) {
            const s = this.opts.getCtx().get("layerManager").create(`checker-${(new Date).getTime()}`);
            s.show();
            const i = () => {
                    s.destroy()
                },
            ...
            const a = {
                ...
                triggerSuccess: () => {
                    i(), e.onSuccess && e.onSuccess(a, "", "", l), t.onSuccess && t.onSuccess()
                },
                cancel: () => {
            ...
            const c = wt(`<input id="check" type="${e.inputType||"text"}" autocomplete="off" required placeholder="">`);
            let d;
            l.appendChild(c), setTimeout((() => c.focus()), 80), c.onkeyup = e => {
                "Enter" !== e.key && 13 !== e.keyCode || (e.preventDefault(), s.getEl().querySelector('button[data-action="confirm"]').click())
            };
            const h = new Jt(l);
            h.setYes((n => {
                ...
                return n.innerText = `${Ot("loading")}...`, e.request(a, s).then((n => {
                    i(), e.onSuccess && e.onSuccess(a, n, s, l), t.onSuccess && t.onSuccess()
                })).catch((t => {
                    var i;
                    i = String(t.message || String(t)), n.innerText = i, n.classList.add("error"), e.onError && e.onError(a, t, s, l);
                    const o = setTimeout((() => r()), 3e3);
                    c.onfocus = () => {
                        r(), clearTimeout(o)
                    }
                })), !1
            })), h.setNo((() => (i(), t.onCancel && t.onCancel(), !1))), o && (c.style.display = "none", h.$el.querySelector(".atk-layer-dialog-actions").style.display = "none"), s.getEl().append(h.$el), t.onMount && t.onMount(h.$el)
        }
    }
    class nn {
        constructor(e) {
    ...
    class rn {
        constructor(e) {
            d(this, "$btn"), d(this, "$panel"), d(this, "editorStateEffectWhen"), this.kit = e
        }
        useBtn(e = "<div></div>") {
            return this.$btn = wt(`<span class="atk-plug-btn">${e}</span>`), this.$btn
        }
        usePanel(e = "<div></div>") {
    ...
    class on extends rn {
        ...
        back() {
            var e;
            this.isMoved && (this.isMoved = !1, null == (e = this.kit.useGlobalCtx().$root.querySelector(".atk-editor-travel-placeholder")) || e.replaceWith(this.kit.useUI().$el), this.kit.useUI().$el.classList.remove("editor-traveling"))
        }
    }
    class an {
        constructor(e) {
            d(this, "stateCurt", "normal"), d(this, "stateUnmountFn", null), this.editor = e
        }
        get() {
        ...
        switch (e, t) {
            var n, s, i, r, o;
            if (this.stateUnmountFn && (this.stateUnmountFn(), this.stateUnmountFn = null, null == (s = null == (n = this.editor.getPlugs()) ? void 0 : n.get(on)) || s.back()), "normal" !== e && t) {
                let n = t.$comment;
                this.editor.conf.flatMode || (n = n.querySelector(".atk-footer")), null == (r = null == (i = this.editor.getPlugs()) ? void 0 : i.get(on)) || r.move(n);
                const s = this.editor.ctx.conf.scrollRelativeTo && this.editor.ctx.conf.scrollRelativeTo();
                Vt(this.editor.getUI().$el, !0, s);
                const a = null == (o = this.editor.getPlugs()) ? void 0 : o.getPlugs().find((t => t.editorStateEffectWhen === e));
    ...
    class ln extends nn {
        ...
        setContent(e) {
            var t;
            this.ui.$textarea.value = e, null == (t = this.getPlugs()) || t.getEvents().trigger("content-updated", e)
        }
        insertContent(e) {
            if (document.selection) this.ui.$textarea.focus(), document.selection.createRange().text = e, this.ui.$textarea.focus();
                ...
                this.setContent(this.ui.$textarea.value.substring(0, t) + e + this.ui.$textarea.value.substring(n, this.ui.$textarea.value.length)), this.ui.$textarea.focus(), this.ui.$textarea.selectionStart = t + e.length, this.ui.$textarea.selectionEnd = t + e.length, this.ui.$textarea.scrollTop = s
        ...
        showNotify(e, t) {
            ! function(e, t, n) {
                const s = wt(`<div class="atk-notify atk-fade-in" style="background-color: ${{s:"#57d59f",e:"#ff6f6c",w:"#ffc721",i:"#2ebcfc"}[n]}"><span class="atk-notify-content"></span></div>`);
                s.querySelector(".atk-notify-content").innerHTML = bt(t).replace("\n", "<br/>"), e.appendChild(s);
                const i = () => {
                    s.classList.add("atk-fade-out"), setTimeout((() => {
                        s.remove()
                    }), 200)
                };
                let r;
    ...
    class cn extends nn {
        ...
        show() {
            return h(this, arguments, (function*(e = {}) {
                if (this.$el.style.transform = "", this.initLayer(), this.layer.show(), this.refreshWhenShow) this.refreshWhenShow = !1, this.$iframeWrap.innerHTML = "", this.$iframe = this.createIframe(e.view), this.$iframeWrap.append(this.$iframe);
                else {
                    const e = this.$iframe,
                        t = e.src;
                    this.getDarkMode() !== t.includes("&darkMode=1") && this.iframeLoad(e, t.replace(/&darkMode=\d/, `&darkMode=${Number(this.getDarkMode())}`))
                }
                this.authCheck({
        ...
        authCheck(e) {
            return h(this, null, (function*() {
                const t = (yield this.ctx.getApi().user.getUserStatus(l({}, this.ctx.getApi().getUserFields()))).data;
                t.is_admin && !t.is_login && (this.refreshWhenShow = !0, this.ctx.checkAdmin({
                    onSuccess: () => {
                        setTimeout((() => {
                            e.onSuccess()
                        }), 500)
        ...
        createIframe(e) {
            const t = wt('<iframe referrerpolicy="strict-origin-when-cross-origin"></iframe>'),
                n = Lt({
        ...
        iframeLoad(e, t) {
            e.src = t, Nt(this.$iframeWrap), e.onload = () => {
                Ht(this.$iframeWrap)
            }
        }
    }
    const dn = e => ({
        import: t => {
            (function(e, t = "DATE_DESC", n = 2) {
                ...
                e.filter((e => 0 === e.rid)).forEach((t => {
                    ...
                    i.parent = i, s.push(i),
                        function t(s) {
                            ...
                            0 !== i.length && (s.level >= n && (s = s.parent), i.forEach((e => {
                                const n = {
                                    id: e.id,
                                    comment: e,
                                    children: [],
                ...
                const i = (n, s) => {
                    let i = n.id - s.id;
                    return "DATE_ASC" === t ? i = +new Date(n.comment.date) - +new Date(s.comment.date) : "DATE_DESC" === t ? i = +new Date(s.comment.date) - +new Date(n.comment.date) : "SRC_INDEX" === t ? i = e.indexOf(n.comment) - e.indexOf(s.comment) : "VOTE_UP_DESC" === t && (i = s.comment.vote_up - n.comment.vote_up), i
                };
                return function e(t) {
                    t.forEach((t => {
                ...
                null == (s = e.$commentsWrap) || s.appendChild(i.getEl()), i.getRender().playFadeAnim();
                const r = (n, s) => {
        ...
        insert: (t, n) => {
            ...
            if (0 === t.rid) null == (s = e.$commentsWrap) || s.prepend(i.getEl());
                ...
                n && (n.putChild(i, "DATE_ASC" === e.nestSortBy ? "append" : "prepend"), i.getParents().forEach((e => {
                    e.getRender().heightLimitRemoveForChildren()
                })))
            }
            i.getRender().checkHeightLimit(), i.scrollIntoView(), i.getRender().playFadeAnim()
        }
    });
    ...
    function hn(e, t, n, s) {
        ...
        if (n.visible) {
            const n = i.getEl(),
                s = e.$commentsWrap;
            "append" === t && (null == s || s.append(n)), "prepend" === t && (null == s || s.prepend(n)), i.getRender().playFadeAnim()
        }
    ...
    class un {
        ...
        getStrategy() {
            return this.options.flatMode ? (e = this.options, {
                import: t => {
                    t.forEach((n => {
    ...
    function pn(e, t) {
        t.forEach((({
            ...
            const r = () => {
                if (i) return;
                if (function(e) {
                        return parseFloat(getComputedStyle(e, null).height.replace("px", "")) || 0
                    }(t) <= n) return;
                e.scrollable ? function(e) {
                    if (!e.el) return;
                    ...
                    e.el.classList.add(gn), e.el.style.height = `${e.max}px`, e.el.style.overflow = "hidden";
                    const t = wt(`<div class="atk-height-limit-btn">${Ot("readMore")}</span>`);
                    t.onclick = t => {
                        t.stopPropagation(), mn(e.el), e.afterExpandBtnClick && e.afterExpandBtnClick(t)
                    }, e.el.append(t)
                }({
                    el: t,
                    max: n,
            ...
            if (r(), s) {
                ...
                0 === e.length && (t.style.maxHeight = ""), e.forEach((e => {
                    e.onload = () => r()
                }))
            }
        }))
    ...
    function mn(e) {
        e && e.classList.contains(gn) && (e.classList.remove(gn), Array.from(e.children).forEach((e => {
            e.classList.contains("atk-height-limit-btn") && e.remove()
        })), e.style.height = "", e.style.maxHeight = "", e.style.overflow = "")
    }
    const fn = "atk-height-limit-scroll";

    function kn(e) {
        if (e.$headerNick = e.$el.querySelector(".atk-nick"), e.data.link) {
            const t = wt('<a target="_blank" rel="noreferrer noopener nofollow"></a>');
            t.innerText = e.data.nick, t.href = At(e.data.link) ? e.data.link : `https://${e.data.link}`, e.$headerNick.append(t)
    ...
    function yn(e) {
        ...
        if (t) {
            ...
            s.innerText = t.replace("管理员", Ot("admin")), s.style.backgroundColor = n || "", e.$headerBadgeWrap.append(s)
        } else if (e.data.is_verified) {
            const t = wt(`<span class="atk-verified-icon" title="${Ot("emailVerified")}"></span>`);
    ...
    function $n(e) {
        ...
        t.innerText = e.comment.getDateFormatted(), t.setAttribute("data-atk-comment-date", String(+new Date(e.data.date)))
    }

    function vn(e) {
        if (!e.opts.uaBadge && !e.data.ip_region) return;
        let t = e.$header.querySelector("atk-ua-wrap");
        if (t || (t = wt('<span class="atk-ua-wrap"></span>'), e.$header.append(t)), t.innerHTML = "", e.data.ip_region) {
    ...
    class wn {
        constructor(e) {
            d(this, "opts"), d(this, "$el"), d(this, "isLoading", !1), d(this, "msgRecTimer"), d(this, "msgRecTimerFunc"), d(this, "isConfirming", !1), d(this, "confirmRecTimer"), this.$el = wt('<span class="atk-common-action-btn"></span>'), this.opts = "object" != typeof e ? {
                text: e
            } : e, this.$el.innerText = this.getText(), this.opts.adminOnly && this.$el.setAttribute("atk-only-admin-show", "")
        }
        get isMessaging() {
            ...
            this.$el.onclick = t => {
                if (t.stopPropagation(), !this.isLoading) {
                    if (this.opts.confirm && !this.isMessaging) {
                        const e = () => {
                            this.isConfirming = !1, this.$el.classList.remove("atk-btn-confirm"), this.$el.innerText = this.getText()
                        };
                        if (!this.isConfirming) return this.isConfirming = !0, this.$el.classList.add("atk-btn-confirm"), this.$el.innerText = this.opts.confirmText || Ot("actionConfirm"), void(this.confirmRecTimer = window.setTimeout((() => e()), 5e3));
        ...
        setLoading(e, t) {
            this.isLoading !== e && (this.isLoading = e, e ? (this.$el.classList.add("atk-btn-loading"), this.$el.innerText = t || `${Ot("loading")}...`) : (this.$el.classList.remove("atk-btn-loading"), this.$el.innerText = this.getText()))
        }
        setError(e) {
        ...
        setMsg(e, t, n, s) {
            this.setLoading(!1), t && this.$el.classList.add(t), this.$el.innerText = e, this.setMsgRecTimer((() => {
                this.$el.innerText = this.getText(), t && this.$el.classList.remove(t), s && s()
            }), n || 2500)
        }
        setMsgRecTimer(e, t) {
            this.fireMsgRecTimer(), this.clearMsgRecTimer(), this.msgRecTimerFunc = e, this.msgRecTimer = window.setTimeout((() => {
    ...
    function bn(e) {
        e.opts.vote && (e.voteBtnUp = new wn((() => `${Ot("voteUp")} (${e.data.vote_up||0})`)).appendTo(e.$actions), e.voteBtnUp.setClick((() => {
            e.comment.getActions().vote("up")
        })), e.opts.voteDown && (e.voteBtnDown = new wn((() => `${Ot("voteDown")} (${e.data.vote_down||0})`)).appendTo(e.$actions), e.voteBtnDown.setClick((() => {
    ...
    const Ln = {
        Avatar: function(e) {
            ...
            if (n.src = s ? s(e.data) : e.comment.getGravatarURL(), e.data.link) {
                const s = wt('<a target="_blank" rel="noreferrer noopener nofollow"></a>');
                s.href = At(e.data.link) ? e.data.link : `https://${e.data.link}`, s.append(n), t.append(s)
            } else t.append(n)
        },
        Header: function(e) {
            Object.entries({
        ...
        Content: function(e) {
            if (!e.data.is_collapsed) return e.$content.innerHTML = e.comment.getContentMarked(), void e.$content.classList.remove("atk-hide", "atk-collapsed");
            ...
            n.addEventListener("click", (t => {
                t.stopPropagation(), e.$content.classList.contains("atk-hide") ? (e.$content.innerHTML = e.comment.getContentMarked(), e.$content.classList.remove("atk-hide"), Gt(e.$content), n.innerText = Ot("collapse")) : (e.$content.innerHTML = "", e.$content.classList.add("atk-hide"), n.innerText = Ot("expand"))
            }))
        },
        ReplyAt: function(e) {
            e.opts.flatMode || 0 === e.data.rid || e.opts.replyTo && (e.$replyAt = wt('<span class="atk-item atk-reply-at"><span class="atk-arrow"></span><span class="atk-nick"></span></span>'), e.$replyAt.querySelector(".atk-nick").innerText = `${e.opts.replyTo.nick}`, e.$replyAt.onclick = () => {
        ...
        ReplyTo: function(e) {
            ...
            t.innerText = `@${e.opts.replyTo.nick}`, t.onclick = () => {
                e.comment.getActions().goToReplyComment()
            };
            let n = yt(e.opts.replyTo.content);
            e.opts.replyTo.is_collapsed && (n = `[${Ot("collapsed")}]`), e.$replyTo.querySelector(".atk-content").innerHTML = n, e.$body.prepend(e.$replyTo)
        },
        Pending: function(e) {
    ...
    class Mn {
        constructor(e) {
            d(this, "comment"), d(this, "$el"), d(this, "$main"), d(this, "$header"), d(this, "$headerNick"), d(this, "$headerBadgeWrap"), d(this, "$body"), d(this, "$content"), d(this, "$childrenWrap"), d(this, "$actions"), d(this, "voteBtnUp"), d(this, "voteBtnDown"), d(this, "$replyTo"), d(this, "$replyAt"), this.comment = e
        }
        get data() {
    ...
    class Pn {
        ...
        vote(e) {
            ...
            this.getApi().votes.vote(`comment_${e}`, this.data.id, l({}, this.getApi().getUserFields())).then((e => {
                var t, n;
                this.data.vote_up = e.data.up, this.data.vote_down = e.data.down, null == (t = this.comment.getRender().voteBtnUp) || t.updateText(), null == (n = this.comment.getRender().voteBtnDown) || n.updateText()
            })).catch((e => {
        ...
        adminEdit(e, t) {
            ...
            const n = l({}, this.data);
            "collapsed" === e ? n.is_collapsed = !n.is_collapsed : "pending" === e ? n.is_pending = !n.is_pending : "pinned" === e && (n.is_pinned = !n.is_pinned), this.getApi().comments.updateComment(this.data.id, l({}, n)).then((e => {
        ...
        adminDelete(e) {
            e.isLoading || (e.setLoading(!0, `${Ot("deleting")}...`), this.getApi().comments.deleteComment(this.data.id).then((() => {
                e.setLoading(!1), this.opts.onDelete && this.opts.onDelete(this.comment)
            })).catch((t => {
    ...
    class In {
        constructor(e, t) {
            d(this, "$el"), d(this, "renderInstance"), d(this, "actionInstance"), d(this, "data"), d(this, "opts"), d(this, "parent"), d(this, "children", []), d(this, "nestCurt"), this.opts = t, this.data = l({}, e), this.data.date = this.data.date.replace(/-/g, "/"), this.parent = null, this.nestCurt = 1, this.actionInstance = new Pn(this), this.renderInstance = new Mn(this)
        }
        render() {
            const e = this.renderInstance.render();
            this.$el && this.$el.replaceWith(e), this.$el = e, this.opts.onAfterRender && this.opts.onAfterRender()
        }
        getActions() {
        ...
        putChild(e, t = "append") {
            ...
            const n = this.getChildrenWrapEl(),
                s = e.getEl();
            "append" === t ? n.append(s) : "prepend" === t && n.prepend(s), e.getRender().playFadeAnim(), e.getRender().checkHeightLimit()
        }
        getChildrenWrapEl() {
        ...
        scrollIntoView() {
            this.$el && Vt(this.$el, !1, this.opts.scrollRelativeTo && this.opts.scrollRelativeTo())
        }
        remove() {
            var e;
        ...
        getDateFormatted() {
            ...
            return (null == (t = (e = this.opts).dateFormatter) ? void 0 : t.call(e, n)) || St(n, Ot)
        }
        getUserUA() {
            const e = function(e) {
                const t = window || {},
                    ...
                    a = {
                        ...
                        "Windows Phone": s.includes("IEMobile") || s.includes("Windows Phone"),
                    ...
                    l = {
                        Mobile: s.includes("Mobi") || s.includes("iPh") || s.includes("480"),
                        Tablet: s.includes("Tablet") || s.includes("Pad") || s.includes("Nexus 7")
                    };
                l.Mobile ? l.Mobile = !s.includes("iPad") : o.Chrome && s.includes("Edg") ? (o.Chrome = !1, o.Edge = !0) : t.showModalDialog && t.chrome && (o.Chrome = !1, o[360] = !0), i.device = "PC", i.language = (() => {
                ...
                const d = {
                    ...
                    iOS: () => s.replace(/^.*OS ([\d_]+) like.*$/, "$1").replace(/_/g, "."),
                    Debian: () => s.replace(/^.*Debian\/([\d.]+).*$/, "$1"),
                    "Windows Phone": () => s.replace(/^.*Windows Phone( OS)? ([\d.]+);.*$/, "$2"),
                    macOS: () => s.replace(/^.*Mac OS X ([\d_]+).*$/, "$1").replace(/_/g, "."),
                    WebOS: () => s.replace(/^.*hpwOS\/([\d.]+);.*$/, "$1")
                };
                i.osVersion = "", d[i.os] && (i.osVersion = d[i.os](), i.osVersion === s && (i.osVersion = ""));
                const h = {
                    Safari: () => s.replace(/^.*Version\/([\d.]+).*$/, "$1"),
                    Chrome: () => s.replace(/^.*Chrome\/([\d.]+).*$/, "$1").replace(/^.*CriOS\/([\d.]+).*$/, "$1"),
                    IE: () => s.replace(/^.*MSIE ([\d.]+).*$/, "$1").replace(/^.*rv:([\d.]+).*$/, "$1"),
                    Edge: () => s.replace(/^.*(Edge|Edg|Edg[A-Z]{1})\/([\d.]+).*$/, "$2"),
                    Firefox: () => s.replace(/^.*Firefox\/([\d.]+).*$/, "$1").replace(/^.*FxiOS\/([\d.]+).*$/, "$1"),
                    "Firefox Focus": () => s.replace(/^.*Focus\/([\d.]+).*$/, "$1"),
                    Chromium: () => s.replace(/^.*Chromium\/([\d.]+).*$/, "$1"),
                    Opera: () => s.replace(/^.*Opera\/([\d.]+).*$/, "$1").replace(/^.*OPR\/([\d.]+).*$/, "$1"),
                    ...
                    Sogou: () => s.replace(/^.*SE ([\d.X]+).*$/, "$1").replace(/^.*SogouMobileBrowser\/([\d.]+).*$/, "$1"),
                ...
                return i.version = "", h[i.browser] && (i.version = h[i.browser](), i.version === s && (i.version = "")), i.version.indexOf(".") && (i.version = i.version.substring(0, i.version.indexOf("."))), "iOS" === i.os && s.includes("iPad") ? i.os = "iPadOS" : "Edge" !== i.browser || s.includes("Edg") ? "MIUI" === i.browser ? i.os = "Android" : "Chrome" === i.browser && Number(i.version) > 27 || "Opera" === i.browser && Number(i.version) > 12 || "Yandex" === i.browser ? i.engine = "Blink" : void 0 === i.browser && (i.browser = "Unknow App") : i.engine = "EdgeHTML", i
            }(this.data.ua);
            return {
    ...
    class Rn {
        constructor(e) {
            d(this, "opts"), d(this, "$el"), d(this, "$loading"), d(this, "$text"), d(this, "offset", 0), d(this, "total", 0), d(this, "origText", "Load More"), this.opts = e, this.origText = this.opts.text || this.origText, this.$el = wt(`<div class="atk-list-read-more" style="display: none;">\n      <div class="atk-list-read-more-inner">\n        <div class="atk-loading-icon" style="display: none;"></div>\n        <span class="atk-text">${this.origText}</span>\n      </div>\n    </div>`), this.$loading = this.$el.querySelector(".atk-loading-icon"), this.$text = this.$el.querySelector(".atk-text"), this.$el.onclick = () => {
                this.click()
            }
        }
        get hasMore() {
        ...
        showErr(e) {
            this.setLoading(!1), this.$text.innerText = e, this.$el.classList.add("atk-err"), window.setTimeout((() => {
    ...
    class Un {
        ...
        create(e) {
            return this.opt = e, this.instance = new Rn({
                pageSize: e.pageSize,
                onClick: t => h(this, null, (function*() {
                    e.ctx.fetch({
                        offset: t
                    })
                })),
    ...
    class qn {
        ...
        update(e, t) {
            this.page = Math.ceil(e / this.pageSize) + 1, this.total = t, this.setInput(this.page), this.checkDisabled()
        }
        setInput(e) {
            this.$input.value = `${e}`
        }
        input(e = !1) {
            ...
            const t = this.$input.value.trim(),
                n = () => {
                    ...
                    let e = Number(t);
                    Number.isNaN(e) || e < 1 ? this.setInput(this.page) : (e > this.maxPage && (this.setInput(this.maxPage), e = this.maxPage), this.change(e))
                };
    ...
    class _n {
        ...
        create(e) {
            return this.instance = new qn(e.total, {
                pageSize: e.pageSize,
                onChange: t => h(this, null, (function*() {
    ...
    function On(e) {
        ...
        return t ? (n.offset = t.params.offset, t.data && (n.total = t.params.flatMode ? t.data.count : t.data.roots_count), n) : n
    }
    const Dn = e => {
        let t = null;
        e.watchConf(["pagination", "locale"], (n => {
            ...
            e.getData().getComments().length > 0 && (null == t ? void 0 : t.getIsClearComments(n)) && e.getData().clearComments()
        })), e.on("list-failed", (() => {
            var e;
            null == (e = null == t ? void 0 : t.showErr) || e.call(t, Ot("loadFail"))
        })), e.on("list-fetch", (e => {
    ...
    class Bn extends nn {
        constructor(e) {
            super(e), d(this, "$commentsWrap"), d(this, "commentNodes", []), this.$el = wt('<div class="atk-list">\n  <div class="atk-list-header">\n    <div class="atk-comment-count">\n      <div class="atk-text"></div>\n    </div>\n    <div class="atk-right-action">\n      <span data-action="admin-close-comment" class="atk-hide" atk-only-admin-show></span>\n      <span data-action="open-sidebar" class="atk-hide atk-on">\n        <span class="atk-unread-badge" style="display: none"></span>\n        <div class="atk-text"></div>\n      </span>\n    </div>\n  </div>\n  <div class="atk-list-body">\n    <div class="atk-list-comments-wrap"></div>\n  </div>\n  <div class="atk-list-footer">\n    <div class="atk-copyright"></div>\n  </div>\n</div>\n'), this.$commentsWrap = this.$el.querySelector(".atk-list-comments-wrap"), Dn(e), this.initCrudEvents()
        }
        getCommentsWrapEl() {
                ...
                createCommentNode: (t, n) => {
                    const s = function(e, t, n, s) {
                        const i = new In(t, {
                            ...
                            replyTo: n,
                            flatMode: "boolean" == typeof(null == s ? void 0 : s.forceFlatMode) ? null == s ? void 0 : s.forceFlatMode : e.conf.flatMode,
        ...
        initCrudEvents() {
            this.ctx.on("list-load", (e => {
                ...
                0 === e.length && (this.commentNodes = [], this.$commentsWrap.innerHTML = "")
            })), this.ctx.on("comment-inserted", (e => {
                var t;
                const n = e.rid ? null == (t = this.commentNodes.find((t => t.getID() === e.rid))) ? void 0 : t.getData() : void 0;
                this.getListLayout().insert(e, n)
            })), this.ctx.on("comment-deleted", (e => {
                const t = this.commentNodes.find((t => t.getID() === e.id));
                t ? (t.remove(), this.commentNodes = this.commentNodes.filter((t => t.getID() !== e.id))) : console.error(`comment node id=${e.id} not found`)
    ...
    function Wn() {
        return {
            ...
            lock() {
                ...
                document.body.style.paddingRight = `${function(){const e=document.createElement("p");e.style.width="100%",e.style.height="200px";const t=document.createElement("div");t.style.position="absolute",t.style.top="0px",t.style.left="0px",t.style.visibility="hidden",t.style.width="200px",t.style.height="150px",t.style.overflow="hidden",t.appendChild(e),document.body.appendChild(t);const n=e.offsetWidth;t.style.overflow="scroll";let s=e.offsetWidth;return n===s&&(s=t.clientWidth),document.body.removeChild(t),n-s}()+e||0}px`
            }
        }
    }
    class zn {
        constructor(e, t) {
            d(this, "allowMaskClose", !0), d(this, "onAfterHide"), this.$el = e, this.opts = t
        }
        setOnAfterHide(e) {
            this.onAfterHide = e
        }
    ...
    class Nn {
        ...
        createItem(e, t) {
            (t = t || this.createItemElement(e)).setAttribute("data-layer-name", e), this.$wrap.appendChild(t);
            const n = new zn(t, {
        ...
        createItemElement(e) {
            const t = document.createElement("div");
            return t.classList.add("atk-layer-item"), t.style.display = "none", this.$wrap.appendChild(t), t
        }
        getWrap() {
            return this.$wrap
        }
        ...
        hideWrap(e) {
            this.items.map((e => e.getEl())).filter((t => t !== e && t.isConnected && "none" !== t.style.display)).length > 0 || (this.$wrap.style.display = "none", Wn().unlock())
        }
    }
    class Hn {
        constructor(e) {
            d(this, "wrap"), this.wrap = new Nn, document.body.appendChild(this.wrap.getWrap()), e.on("unmounted", (() => {
    ...
    const Gn = {
        i18n(e) {
            _t(e.conf.locale), e.watchConf(["locale"], (e => {
                _t(e.locale)
            }))
        },
        user: e => new Vn({
        ...
        checkerLauncher: e => new tn({
            getCtx: () => e,
            getApi: () => e.getApi(),
            onReload: () => e.reload(),
            getCaptchaIframeURL: () => `${e.conf.server}/api/v2/captcha/?t=${+new Date}`
        }),
        editor(e) {
            const t = new ln(e);
    ...
    function Zn(e) {
        return h(this, null, (function*() {
            ...
            const s = function(e) {
                ...
                i = function(e, t, n, s) {
                    const i = Array.from(e).map((e => e.getAttribute(t) || n)).filter((e => e && "number" != typeof s[e]));
                    return [...new Set(i)]
        ...
        getSubmitAddParams() {
            return h(this, null, (function*() {
                const {
                    ...
                    email: t,
                    link: n
                } = this.kit.useUser().getData(), s = this.kit.useConf();
                return {
    ...
    class Jn extends rn {
        constructor(e) {
            super(e), d(this, "customs", []), d(this, "defaultPreset"), this.defaultPreset = new Xn(this.kit);
            const t = () => this.do();
            this.kit.useMounted((() => {
        ...
        do() {
            return h(this, null, (function*() {
                ...
                try {
                    let t;
                    (null == e ? void 0 : e.pre) && e.pre(), t = (null == e ? void 0 : e.req) ? yield e.req(): yield this.defaultPreset.reqAdd(), (null == e ? void 0 : e.post) ? e.post(t) : this.defaultPreset.postSubmitAdd(t)
                } catch (t) {
                    return console.error(t), void this.kit.useEditor().showNotify(`${Ot("commentFail")}: ${t.message||String(t)}`, "e")
                } finally {
    ...
    class es extends rn {
        constructor(e) {
            super(e), d(this, "emoticons", []), d(this, "loadingTask", null), d(this, "$grpWrap"), d(this, "$grpSwitcher"), d(this, "isListLoaded", !1), d(this, "isImgLoaded", !1), this.kit.useMounted((() => {
            ...
            })), this.kit.useUnmounted((() => {})), this.useContentTransformer((e => this.transEmoticonImageText(e))), this.usePanelShow((() => {
                (() => {
                    h(this, null, (function*() {
                        yield this.loadEmoticonsData(), this.isImgLoaded || (this.initEmoticonsList(), this.isImgLoaded = !0), setTimeout((() => {
        ...
        loadEmoticonsData() {
            return h(this, null, (function*() {
                this.isListLoaded || (null === this.loadingTask ? (this.loadingTask = (() => h(this, null, (function*() {
                    Nt(this.$panel), this.emoticons = yield this.handleData(this.kit.useConf().emoticons), Ht(this.$panel), this.loadingTask = null, this.isListLoaded = !0
                })))(), yield this.loadingTask) : yield this.loadingTask)
            }))
        }
        handleData(e) {
            return h(this, null, (function*() {
                if (!Array.isArray(e) && ["object", "string"].includes(typeof e) && (e = [e]), !Array.isArray(e)) return Kt(this.$panel, `[${Ot("emoticon")}] Data must be of Array/Object/String type`), Ht(this.$panel), [];
                const t = t => {
                        "object" == typeof t && (t.name && e.find((e => e.name === t.name)) || e.push(t))
                    },
                    n = e => h(this, null, (function*() {
                        yield Promise.all(e.map(((e, s) => h(this, null, (function*() {
                            if ("object" != typeof e || Array.isArray(e)) {
                                if (Array.isArray(e)) yield n(e);
                                else if ("string" == typeof e) {
                                    const s = yield this.remoteLoad(e);
                                    Array.isArray(s) ? yield n(s): "object" == typeof s && t(s)
                                }
                            } else t(e)
                        })))))
                    }));
                ...
                })), e = e.filter((e => "object" == typeof e && !Array.isArray(e) && !!e && !!e.name)), this.solveNullKey(e), this.solveSameKey(e), e
            }))
        }
        remoteLoad(e) {
            return h(this, null, (function*() {
                ...
                try {
                    ...
                    return Ht(this.$panel), console.error("[Emoticons] Load Failed:", t), Kt(this.$panel, `[${Ot("emoticon")}] ${Ot("loadFail")}: ${String(t)}`), []
                }
            }))
        }
        solveNullKey(e) {
        ...
        solveSameKey(e) {
            ...
            e.forEach((e => {
                e.items.forEach((e => {
                    e.key && "" !== String(e.key).trim() && (t[e.key] ? t[e.key]++ : t[e.key] = 1, t[e.key] > 1 && (e.key = `${e.key} ${t[e.key]}`))
                }))
            }))
        }
        isOwOFormat(e) {
        ...
        initEmoticonsList() {
            this.$grpWrap = wt('<div class="atk-grp-wrap"></div>'), this.$panel.append(this.$grpWrap), this.emoticons.forEach(((e, t) => {
                const n = wt('<div class="atk-grp" style="display: none;"></div>');
                this.$grpWrap.append(n), n.setAttribute("data-index", String(t)), n.setAttribute("data-grp-name", e.name), n.setAttribute("data-type", e.type), e.items.forEach((t => {
                    const s = wt('<span class="atk-item"></span>');
                    if (n.append(s), t.key && !new RegExp(`^(${e.name})?\\s?[0-9]+$`).test(t.key) && s.setAttribute("title", t.key), "image" === e.type) {
                        const e = document.createElement("img");
                        e.src = t.val, e.alt = t.key, s.append(e)
                    } else s.innerText = t.val;
                    s.onclick = () => {
                        "image" === e.type ? this.kit.useEditor().insertContent(`:[${t.key}]`) : this.kit.useEditor().insertContent(t.val || "")
                    }
                }))
            })), this.emoticons.length > 1 && (this.$grpSwitcher = wt('<div class="atk-grp-switcher"></div>'), this.$panel.append(this.$grpSwitcher), this.emoticons.forEach(((e, t) => {
                const n = wt("<span />");
                n.innerText = e.name, n.setAttribute("data-index", String(t)), n.onclick = () => this.openGrp(t), this.$grpSwitcher.append(n)
        ...
        openGrp(e) {
            ...
            })), null == (t = this.$grpSwitcher) || t.querySelectorAll("span.active").forEach((e => e.classList.remove("active"))), null == (s = null == (n = this.$grpSwitcher) ? void 0 : n.querySelector(`span[data-index="${e}"]`)) || s.classList.add("active"), this.changeListHeight()
        }
        changeListHeight() {}
        transEmoticonImageText(e) {
            return this.emoticons && Array.isArray(this.emoticons) ? (this.emoticons.forEach((t => {
                "image" === t.type && Object.entries(t.items).forEach((([t, n]) => {
                    e = e.split(`:[${n.key}]`).join(`<img src="${n.val}" atk-emoticon="${n.key}">`)
                }))
            })), e) : e
        }
    }
    ...
    class ns extends rn {
        ...
        initDragImg() {
            ...
            this.kit.useMounted((() => {
                this.kit.useUI().$textarea.addEventListener("dragover", t), this.kit.useUI().$textarea.addEventListener("drop", n), this.kit.useUI().$textarea.addEventListener("paste", s)
            })), this.kit.useUnmounted((() => {
                this.kit.useUI().$textarea.removeEventListener("dragover", t), this.kit.useUI().$textarea.removeEventListener("drop", n), this.kit.useUI().$textarea.removeEventListener("paste", s)
            }))
        }
        uploadImg(e) {
            return h(this, null, (function*() {
                ...
                try {
                    ...
                    } : (yield this.kit.useApi().upload.upload({
                        file: e
                    })).data
                } catch (r) {
                    console.error(r), this.kit.useEditor().showNotify(`${Ot("uploadFail")}: ${r.message}`, "e")
                }
                if (i && i.public_url) {
                    let e = i.public_url;
                    At(e) || (e = Lt({
                        ...
                        path: e
                    })), this.kit.useEditor().setContent(this.kit.useUI().$textarea.value.replace(s, `${n}![](${e})`))
    ...
    class ss extends rn {
        constructor(e) {
            super(e), d(this, "isPlugPanelShow", !1), this.kit.useMounted((() => {
    ...
    const is = [class extends rn {
        constructor(e) {
            ...
            this.kit.useMounted((() => {
                ...
                "" !== e.trim() && (this.kit.useEditor().showNotify(Ot("restoredMsg"), "i"), this.kit.useEditor().setContent(e)), this.kit.useEvents().on("content-updated", t)
            })), this.kit.useUnmounted((() => {
        ...
        constructor(e) {
            ...
            this.kit.useMounted((() => {
                Object.entries(this.$inputs).forEach((([e, i]) => {
                    i.addEventListener("input", t[e] = s("header-input", i, e)), i.addEventListener("change", n[e] = s("header-change", i, e))
                }))
            })), this.kit.useUnmounted((() => {
                Object.entries(this.$inputs).forEach((([e, s]) => {
                    s.removeEventListener("input", t[e]), s.removeEventListener("change", n[e])
                }))
            }))
        }
    }, class extends rn {
        constructor(e) {
            super(e), d(this, "query", {
                timer: null,
                abortFn: null
            });
            const t = ({
            ...
            this.kit.useMounted((() => {
                Object.entries(this.kit.useEditor().getHeaderInputEls()).forEach((([e, t]) => {
                    t.placeholder = n[e], t.value = this.kit.useUser().getData()[e] || ""
        ...
        fetchUserInfo() {
            this.kit.useUser().logout(), this.query.timer && window.clearTimeout(this.query.timer), this.query.abortFn && this.query.abortFn(), this.query.timer = window.setTimeout((() => {
                ...
                this.query.abortFn = () => e.abortRequest(t), e.user.getUser(l({}, e.getUserFields()), {
                    cancelToken: t
                }).then((e => this.onUserInfoFetched(e.data))).catch((e => {})).finally((() => {
        ...
        onUserInfoFetched(e) {
            var t;
            e.is_login || this.kit.useUser().logout(), this.kit.useGlobalCtx().getData().updateNotifies(e.notifies), this.kit.useUser().checkHasBasicUserInfo() && !e.is_login && (null == (t = e.user) ? void 0 : t.is_admin) && this.kit.useGlobalCtx().checkAdmin({
                onSuccess: () => {}
            }), e.user && e.user.link && (this.kit.useUI().$link.value = e.user.link, this.kit.useUser().update({
                link: e.user.link
            }))
        }
    }, class extends rn {
        ...
        onLinkInputChange() {
            ...
            e && !/^(http|https):\/\//.test(e) && (this.kit.useUI().$link.value = `https://${e}`, this.kit.useUser().update({
        ...
        constructor(e) {
            ...
            const t = e => this.onKeydown(e),
                n = () => this.onInput();
            this.kit.useMounted((() => {
                this.kit.useUI().$textarea.placeholder = this.kit.useConf().placeholder || Ot("placeholder"), this.kit.useUI().$textarea.addEventListener("keydown", t), this.kit.useUI().$textarea.addEventListener("input", n)
            })), this.kit.useUnmounted((() => {
                this.kit.useUI().$textarea.removeEventListener("keydown", t), this.kit.useUI().$textarea.removeEventListener("input", n)
        ...
        adaptiveHeightByContent() {
            const e = this.kit.useUI().$textarea.offsetHeight - this.kit.useUI().$textarea.clientHeight;
            this.kit.useUI().$textarea.style.height = "0px", this.kit.useUI().$textarea.style.height = `${this.kit.useUI().$textarea.scrollHeight+e}px`
        }
    }, Jn, class extends rn {
        constructor(e) {
            super(e);
            ...
            this.kit.useMounted((() => {
                this.kit.useUI().$submitBtn.innerText = this.kit.useConf().sendBtn || Ot("send"), this.kit.useUI().$submitBtn.addEventListener("click", t)
            })), this.kit.useUnmounted((() => {
        ...
        constructor(e) {
            super(e), d(this, "comment"), this.useEditorStateEffect("reply", (e => (this.setReply(e), () => {
                this.cancelReply()
                ...
                e.registerCustom({
                    ...
                    req: () => h(this, null, (function*() {
                        if (!this.comment) throw new Error("reply comment cannot be empty");
                        return (yield this.kit.useApi().comments.createComment(c(l({}, yield t.getSubmitAddParams()), {
                            rid: this.comment.id,
                    ...
                    post: e => {
                        ...
                        e.page_key !== n.pageKey && window.open(`${e.page_url}#atk-comment-${e.id}`), t.postSubmitAdd(e)
                    }
                })
            }))
        }
        setReply(e) {
            ...
            if (!t.$sendReplyBtn) {
                const n = wt(`<span class="atk-state-btn"><span class="atk-text-wrap">${Ot("reply")} <span class="atk-text"></span></span><span class="atk-cancel atk-icon-close atk-icon"></span></span>`);
                n.querySelector(".atk-text").innerText = `@${e.nick}`, n.addEventListener("click", (() => {
                    this.kit.useEditor().resetState()
                })), t.$stateWrap.append(n), t.$sendReplyBtn = n
            }
        ...
        cancelReply() {
            ...
            e.$sendReplyBtn && (e.$sendReplyBtn.remove(), e.$sendReplyBtn = void 0), this.comment = void 0
        }
    }, class extends rn {
        constructor(e) {
            super(e), d(this, "comment"), d(this, "originalSubmitBtnText", "Send"), this.useEditorStateEffect("edit", (e => (this.edit(e), () => {
                this.cancelEdit()
            }))), this.kit.useMounted((() => {
                const e = this.kit.useDeps(Jn);
                if (!e) throw Error("SubmitPlug not initialized");
                e.registerCustom({
                    ...
                    req: () => h(this, null, (function*() {
                        const e = {
                            ...
                            t = this.comment;
                        return (yield this.kit.useApi().comments.updateComment(t.id, l(l({}, t), e))).data
                    })),
                    post: e => {
        ...
        edit(e) {
            const t = this.kit.useUI();
            if (!t.$editCancelBtn) {
                const e = wt(`<span class="atk-state-btn"><span class="atk-text-wrap">${Ot("editCancel")}</span><span class="atk-cancel atk-icon-close atk-icon"></span></span>`);
                e.onclick = () => {
                    this.kit.useEditor().resetState()
                }, t.$stateWrap.append(e), t.$editCancelBtn = e
            }
            this.comment = e, t.$header.style.display = "none", t.$name.value = e.nick || "", t.$email.value = e.email || "", t.$link.value = e.link || "", this.kit.useEditor().setContent(e.content), t.$textarea.focus(), this.updateSubmitBtnText(Ot("save"))
        }
        cancelEdit() {
            if (!this.comment) return;
            const e = this.kit.useUI();
            e.$editCancelBtn && (e.$editCancelBtn.remove(), e.$editCancelBtn = void 0), this.comment = void 0;
            const {
                name: t,
                email: n,
                link: s
            } = this.kit.useUser().getData();
            e.$name.value = t, e.$email.value = n, e.$link.value = s, this.kit.useEditor().setContent(""), this.restoreSubmitBtnText(), e.$header.style.display = ""
        }
        updateSubmitBtnText(e) {
            this.originalSubmitBtnText = this.kit.useUI().$submitBtn.innerText, this.kit.useUI().$submitBtn.innerText = e
        }
        ...
        constructor(e) {
            ...
            const t = () => this.open(),
                n = () => this.close();
            this.kit.useMounted((() => {
                this.kit.useEvents().on("editor-open", t), this.kit.useEvents().on("editor-close", n)
            })), this.kit.useUnmounted((() => {
                this.kit.useEvents().off("editor-open", t), this.kit.useEvents().off("editor-close", n)
            }))
        }
        open() {
            var e;
            null == (e = this.kit.useUI().$textareaWrap.querySelector(".atk-comment-closed")) || e.remove(), this.kit.useUI().$textarea.style.display = "", this.kit.useUI().$bottom.style.display = ""
        }
        close() {
    ...
    class os {
        constructor(e) {
            d(this, "plugs", []), d(this, "openedPlug", null), d(this, "events", new Dt), this.editor = e;
            let t = !1;
            this.editor.ctx.watchConf(["imgUpload", "emoticons", "preview", "editorTravel", "locale"], (e => {
                t && this.getEvents().trigger("unmounted"), this.clear(),
                    function(e) {
                        const t = new Map;
                        return t.set(ns, e.imgUpload), t.set(es, e.emoticons), t.set(ss, e.preview), t.set(on, e.editorTravel), is.filter((e => !t.has(e) || !!t.get(e)))
                    }(e).forEach((e => {
                        const t = new rs(this);
        ...
        loadPluginItem(e) {
            ...
            this.editor.getUI().$plugBtnWrap.appendChild(t), !t.onclick && (t.onclick = () => {
                this.editor.getUI().$plugBtnWrap.querySelectorAll(".active").forEach((e => e.classList.remove("active"))), e !== this.openedPlug ? (this.openPlugPanel(e), t.classList.add("active")) : this.closePlugPanel()
            });
            const n = e.$panel;
        ...
        openPlugPanel(e) {
            this.plugs.forEach((t => {
                const n = t.$panel;
                n && (t === e ? (n.style.display = "", this.events.trigger("panel-show", e)) : (n.style.display = "none", this.events.trigger("panel-hide", e)))
    ...
    function ls(e) {
        ...
        if (e.onOpenSidebar) {
            const n = wt(`<span atk-only-admin-show> | <span style="cursor:pointer;">${Ot("openName",{name:Ot("ctrlCenter")})}</span></span>`);
    ...
    const us = [e => {
            e.watchConf(["imgLazyLoad", "markedOptions"], (t => {
                ! function(e) {
                    ...
                    t.setOptions(l(l({
                        renderer: dt({
                            imgLazyLoad: e.imgLazyLoad
                        })
                    }, ft), e.markedOptions)), gt = t
                }({
            ...
            const t = () => {
                ...
                t = e.get("user").getData().is_admin,
                    function(e) {
                        ...
                        return n && n.querySelectorAll("[atk-only-admin-show]").forEach((e => t.push(e))), t
                    }({
                        $root: e.$root
                    }).forEach((e => {
            ...
            e.on("list-fetch", (t => {
                ...
                n.paramsModifier && n.paramsModifier(s), e.getApi().comments.getComments(l(l({}, s), e.getApi().getUserFields())).then((({
                    data: t
                }) => {
                    e.getData().setListLastFetch({
                        params: n,
                        data: t
                    }), e.getData().loadComments(t.comments), e.getData().updatePage(t.page), n.onSuccess && n.onSuccess(t), e.trigger("list-fetched", {
                        params: n,
                        data: t
                    })
                })).catch((t => {
            ...
            e.on("comment-rendered", (t => {
                if (!0 === e.conf.listUnreadHighlight) {
                    ...
                    s ? (t.getRender().setUnread(!0), t.getRender().setOpenAction((() => {
                        window.open(s.read_link), e.getData().updateNotifies(n.filter((e => e.comment_id !== t.getID())))
                    }))) : t.getRender().setUnread(!1)
                }
            })), e.on("list-goto", (t => {
                const n = xt("atk_notify_key");
                n && e.getApi().notifies.markNotifyRead(t, n).then((() => {
                    e.getData().updateNotifies(e.getData().getNotifies().filter((e => e.comment_id !== t)))
                }))
            }))
        }, e => {
            let t;
            e.on("mounted", (() => {
                const n = e.get("list");
                t = n.$el.querySelector('[data-action="admin-close-comment"]'), t.addEventListener("click", (() => {
                    const t = e.getData().getPage();
                    if (!t) throw new Error("Page data not found");
                    t.admin_only = !t.admin_only,
                        function(e, t) {
                            e.editorShowLoading(), e.getApi().pages.updatePage(t.id, t).then((({
                                data: t
                            }) => {
                                e.getData().updatePage(t)
                            })).catch((t => {
                                e.editorShowNotify(`${Ot("editFail")}: ${t.message||String(t)}`, "e")
                            })).finally((() => {
                                e.editorHideLoading()
                            }))
                        }(e, t)
                ...
                !0 === (null == n ? void 0 : n.admin_only) ? (null == (s = r.getPlugs()) || s.getEvents().trigger("editor-close"), t && (t.innerText = Ot("openComment"))) : (null == (i = r.getPlugs()) || i.getEvents().trigger("editor-open"), t && (t.innerText = Ot("closeComment")))
            })), e.on("list-loaded", (t => {
                e.editorResetState()
            }))
        }, e => {
            e.on("list-loaded", (() => {
                (() => {
                    var t, n;
                    const s = e.get("list").$el.querySelector(".atk-comment-count .atk-text");
                    if (!s) return;
                    const i = bt(Ot("counter", {
                        count: `${Number(null==(n=null==(t=e.getData().getListLastFetch())?void 0:t.data)?void 0:n.count)||0}`
                    }));
                    s.innerHTML = i.replace(/(\d+)/, '<span class="atk-comment-count-num">$1</span>')
                })()
            ...
            const n = () => {
                ...
                if (n.name && n.email) {
                    ...
                    e && (e.innerText = n.is_admin ? Ot("ctrlCenter") : Ot("msgCenter"))
                } else t.classList.add("atk-hide")
            };
            e.watchConf(["locale"], (s => {
                const i = e.get("list");
                t = i.$el.querySelector('[data-action="open-sidebar"]'), t && (t.onclick = () => {
                    e.showSidebar()
                }, n())
            })), e.on("user-changed", (e => {
                n()
            ...
            e.on("mounted", (() => {
                ...
                var n;
                n = e.length || 0, t && (n > 0 ? (t.innerText = `${Number(n||0)}`, t.style.display = "block") : t.style.display = "none")
            }))
        }, e => {
            const t = t => {
                ...
                n = e => {
                    ! function(e) {
                        ...
                        t.classList.add("atk-dropdown-wrap"), t.append(wt('<span class="atk-arrow-down-icon"></span>'));
                        let s = 0;
                        const i = (e, t, n, i) => {
                                i(), s = e, r.querySelectorAll(".active").forEach((e => {
                                    e.classList.remove("active")
                                })), t.classList.add("active"), r.style.display = "none", setTimeout((() => {
                                    r.style.display = ""
                                }), 80)
                            },
                            r = wt('<ul class="atk-dropdown atk-fade-in"></ul>');
                        n.forEach(((e, t) => {
                            const [n, o] = e, a = wt('<li class="atk-dropdown-item"><span></span></li>'), l = a.querySelector("span");
                            l.innerText = n, l.onclick = () => {
                                i(t, a, n, o)
                            }, r.append(a), t === s && a.classList.add("active")
                        })), t.append(r)
                    }({
                        $dropdownWrap: e,
                        dropdownList: [
            ...
            e.watchConf(["listSort", "locale"], (t => {
                ...
                s && (t.listSort ? n(s) : function(e) {
                    var t, n;
                    const {
                        $dropdownWrap: s
                    } = e;
                    s.classList.remove("atk-dropdown-wrap"), null == (t = s.querySelector(".atk-arrow-down-icon")) || t.remove(), null == (n = s.querySelector(".atk-dropdown")) || n.remove()
                }({
                    $dropdownWrap: s
                }))
            }))
            ...
            const n = ({
                    ...
                    const s = function() {
                        ...
                        let t = e && e[1] && !Number.isNaN(parseFloat(e[1])) ? parseFloat(e[1]) : null;
            ...
            e.on("list-goto", (t => h(this, null, (function*() {
                let n = e.getCommentNodes().find((e => e.getID() === t));
                if (!n) {
                    const s = (yield e.getApi().comments.getComment(t)).data;
                    e.get("list").getListLayout({
                        forceFlatMode: !0
                    }).insert(s.comment, s.reply_comment), n = e.getCommentNodes().find((e => e.getID() === t))
                }
                n && n.focus()
            }))))
        }, e => {
            e.on("list-loaded", (t => {
                ...
                s ? i || (i = wt('<div class="atk-list-no-comment"></div>'), i.innerHTML = ot(n.ctx.conf.noComment || n.ctx.$t("noComment")), n.getCommentsWrapEl().appendChild(i)) : null == i || i.remove()
            }))
        }, e => {
            let t = null;
            e.on("mounted", (() => {
                t = window.setInterval((() => {
                    e.get("list").$el.querySelectorAll("[data-atk-comment-date]").forEach((t => {
                        var n, s;
                        const i = new Date(Number(t.getAttribute("data-atk-comment-date")));
                        t.innerText = (null == (s = (n = e.getConf()).dateFormatter) ? void 0 : s.call(n, i)) || St(i, e.$t)
                    }))
                }), 3e4)
            })), e.on("unmounted", (() => {
            ...
            e.on("list-loaded", (() => {
                ...
                i && ("IntersectionObserver" in window ? (s => {
                    const i = e.conf.scrollRelativeTo && e.conf.scrollRelativeTo() || null;
                    t = new IntersectionObserver((([t]) => {
                        t.isIntersecting && (n(), e.trigger("list-reach-bottom"))
                    }), {
                        threshold: .9,
                        root: i
                    }), t.observe(s)
                })(i) : console.warn("IntersectionObserver api not supported"))
            })), e.on("unmounted", (() => {
                n()
            }))
        }, e => {
            ...
            e.on("list-fetch", (t => {
                ...
                n && e.getApi().notifies.getNotifies(n).then((t => {
                    e.getData().updateNotifies(t.data.notifies)
                }))
            }))
        }, e => {
            e.watchConf(["site", "pageKey", "pageTitle", "countEl", "pvEl", "statPageKeyAttr"], (t => {
                Kn({
                    getApi: () => e.getApi(),
                    siteName: t.site,
                    pageKey: t.pageKey,
            ...
            e.watchConf(["apiVersion", "versionCheck"], (t => {
                const n = e.get("list");
                t.apiVersion && t.versionCheck && !cs && function(e, t, n) {
                    ...
                    if (0 === s) return;
                    const i = wt(`<div class="atk-version-check-notice">${Ot("updateMsg",{name:Ot(s<0?"frontend":"backend")})} <span class="atk-info">${Ot("currentVersion")}: ${Ot("frontend")} ${t} / ${Ot("backend")} ${n}</span></div>`),
                        r = wt(`<span class="atk-ignore-btn">${Ot("ignore")}</span>`);
                    r.onclick = () => {
                        i.remove(), cs = !0
                    }, i.append(r), e.$el.parentElement.prepend(i)
                }(n, as, t.apiVersion)
            }))
        }, e => {
            let t;
            const n = n => {
                ...
                ds || (ds = window.matchMedia("(prefers-color-scheme: dark)")), "auto" === n ? (t || (t = e => hs(s, e.matches), ds.addEventListener("change", t)), hs(s, ds.matches)) : (t && (ds.removeEventListener("change", t), t = void 0), hs(s, n))
            };
            e.watchConf(["darkMode"], (e => n(e.darkMode))), e.on("created", (() => n(e.conf.darkMode))), e.on("unmounted", (() => {
                t && (null == ds || ds.removeEventListener("change", t)), t = void 0
            }))
        }],
        ps = new Set([...us]),
        gs = new WeakMap;
    ...
    function ms(e) {
        return h(this, null, (function*() {
            ...
            const {
                data: i
            } = yield e.getApi().conf.conf().catch((t => {
                throw function(e, t) {
                    var n;
                    let s = "";
                    ...
                    ls({
                        ...
                        errData: t.data,
                        retryFn: () => ms(e),
                        onOpenSidebar: e.get("user").getData().is_admin ? () => e.showSidebar({
                            view: s
                        }) : void 0
                    })
                }(e, t), t
            ...
            let r = {
                apiVersion: null == (t = i.version) ? void 0 : t.version
            };
            if (e.conf.useBackendConf) {
                if (!i.frontend_conf) throw new Error("The remote backend does not respond to the frontend conf, but `useBackendConf` conf is enabled");
                r = l(l({}, r), function(e) {
                    const t = ["el", "pageKey", "pageTitle", "server", "site", "pvEl", "countEl", "statPageKeyAttr"];
                    return Object.keys(e).forEach((n => {
                        t.includes(n) && delete e[n], "darkMode" === n && "auto" !== e[n] && delete e[n]
                    })), e.emoticons && "string" == typeof e.emoticons && (e.emoticons = e.emoticons.trim(), e.emoticons.startsWith("[") || e.emoticons.startsWith("{") ? e.emoticons = JSON.parse(e.emoticons) : "false" === e.emoticons && (e.emoticons = !1)), e
                }(i.frontend_conf))
            }
            e.conf.remoteConfModifier && e.conf.remoteConfModifier(r), r.pluginURLs && (yield function(e, t) {
                return h(this, null, (function*() {
                    const n = new Set;
                    if (!e || !Array.isArray(e)) return n;
                    const s = [];
                    return e.forEach((e => {
                        /^(http|https):\/\//.test(e) || (e = `${t.replace(/\/$/,"")}/${e.replace(/^\//,"")}`), s.push(new Promise((t => {
                            if (document.querySelector(`script[src="${e}"]`)) return void t();
                            const n = document.createElement("script");
                            n.src = e, document.head.appendChild(n), n.onload = () => t(), n.onerror = e => {
                                console.error("[artalk] Failed to load plugin", e), t()
                            }
                        })))
                    })), yield Promise.all(s), Object.values(window.ArtalkPlugins || {}).forEach((e => {
                        "function" == typeof e && n.add(e)
                    })), n
                }))
            }(r.pluginURLs, e.conf.server).then((e => {
                s(e)
            })).catch((e => {
                console.error("Failed to load plugin", e)
            }))), e.trigger("created"), e.updateConf(r), e.trigger("mounted"), e.conf.remoteConfModifier || e.fetch({
                offset: 0
            })
        }))
    }
    class fs {
        constructor(e) {
            d(this, "ctx");
            const t = jt(e, !0);
            this.ctx = new zt(t), Object.entries(Gn).forEach((([e, t]) => {
                const n = t(this.ctx);
    ...
    e.default = fs, e.init = ks, e.loadCountWidget = $s, e.use = ys, Object.defineProperties(e, {
        __esModule: {
            value: !0
        },
        [Symbol.toStringTag]: {
